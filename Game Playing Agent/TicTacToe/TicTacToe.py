...
if __name__ == "__main__":
    ...
    q_rand = battle(board, qlearner, RandomPlayer(), 50)
    rand_q = battle(board, RandomPlayer(), qlearner, 50)
    print('Playing QLearner against SmartPlayer for 100 times......')
    q_smart = battle(board, qlearner, SmartPlayer(), 50)
    smart_q = battle(board, SmartPlayer(), qlearner, 50)
    print('Playing QLearner against PerfectPlayer for 100 times......')
    q_perfect = battle(board, qlearner, PerfectPlayer(), 50)
    perfect_q = battle(board, PerfectPlayer(), qlearner, 50)
